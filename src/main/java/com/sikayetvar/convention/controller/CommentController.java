package com.sikayetvar.convention.controller;

import com.sikayetvar.convention.dto.CommentDTO;
import com.sikayetvar.convention.service.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<?> createComment(@RequestBody @NotNull
        ...
        return new ResponseEntity<CommentDTO>(header, HttpStatus.ACCEPTED);
    }
